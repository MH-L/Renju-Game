...
//		System.out.println(BoardTree.totalTimeElapsed);
	...
	public void testEvaluateBoard() throws InvalidIndexException {
		...
		testBoard.reset();
		testBoard.updateBoardSolitaire(new BoardLocation(7, 7), true);
		testBoard.updateBoardSolitaire(new BoardLocation(8, 7), false);
		testBoard.updateBoardSolitaire(new BoardLocation(7, 8), true);
		testBoard.updateBoardSolitaire(new BoardLocation(7, 6), false);
		testBoard.updateBoardSolitaire(new BoardLocation(6, 6), true);
		testBoard.updateBoardSolitaire(new BoardLocation(6, 7), false);
		testBoard.updateBoardSolitaire(new BoardLocation(6, 8), true);
		testBoard.updateBoardSolitaire(new BoardLocation(5, 8), false);
		testBoard.updateBoardSolitaire(new BoardLocation(4, 9), true);
		testBoard.updateBoardSolitaire(new BoardLocation(8, 8), false);
		testBoard.updateBoardSolitaire(new BoardLocation(5, 7), true);
		testBoard.updateBoardSolitaire(new BoardLocation(6, 9), false);
		testBoard.updateBoardSolitaire(new BoardLocation(7, 9), true);
//		testBoard.updateBoardSolitaire(new BoardLocation(15, 15), false);
		testBoard.renderBoard(2);
		score = BoardTree.evalBoard(testBoard, Board.TURN_SENTE);
		assertEquals(score, 2.46, 0.001);
		score = BoardTree.evalBoard(testBoard, Board.TURN_GOTE);
		assertEquals(score, -1.14, 0.001);
		BoardTree tr = new BoardTree(testBoard, Board.TURN_GOTE);
		BoardLocation move = tr.getBestMove(3);
